...
{
    public class GetCallResultFromNormalDialerCommand : IRequest<Response<string>>
    {
        public DateTime FromDate { get; set; }
        public DateTime ToDate { get; set; }
    }
    public class GetCallResultFromNormalDialerCommandHandler : IRequestHandler<GetCallResultFromNormalDialerCommand, Response<string>>
    {
        private readonly IApplicationDbContext _context;
        private readonly IGeneralOperation _generalOperation;
        public GetCallResultFromNormalDialerCommandHandler(IGeneralOperation generalOperation, IApplicationDbContext dbContext)
        {
            _generalOperation = generalOperation;
            _context = dbContext;

        }
        public async Task<Response<string>> Handle(GetCallResultFromNormalDialerCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                string quaryWhereDate = "Where pcah.contact_attempt_time >= '" + request.FromDate.ToString("yyyy-MM-dd HH:mm:ss") + "' and pcah.contact_attempt_time <= '" + request.ToDate.ToString("yyyy-MM-dd HH:mm:ss") + "' " +
                    " and pcamp.name in ('REDFPredOnMapCam','REDFPreviewCamp','Alahlibank_Camp','Alawwalbank_Camp','Albiladbank_Camp','REDFPredictive01','REDFPredictive02','REDFPredictive03','REDFPredictive04','REDFPredictive05')";
                    ...
                    if (sessionId == null)
                    {
                        ...
                        try
                        {
                            ...
                            var itemForDb = new Pim_contact_attempts_history
                            {
                                ...
                                CallTypeId = Shared.Struct.CallType.Normal
                            };
