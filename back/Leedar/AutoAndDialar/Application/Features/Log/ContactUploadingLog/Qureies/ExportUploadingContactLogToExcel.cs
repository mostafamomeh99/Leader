...
//{
//    public class ExportUploadingContactLogToExcel : IRequest<Response<string>>
//    {
...
//    }
//    public class ExportUploadingContactLogToExcelHandler : IRequestHandler<ExportUploadingContactLogToExcel, Response<string>>
//    {
...
//        public ExportUploadingContactLogToExcelHandler(IApplicationDbContext context, IMapper mapper, IHostingEnvironment hostingEnvironment,
...
//        }
//        public async Task<Response<string>> Handle(ExportUploadingContactLogToExcel request, CancellationToken cancellationToken)
//        {
...
//                ContactUploadingLog = ContactUploadingLog.Where(x=>x.IsUploadedSuccessfully==true);
//                #endregion
...
//                string excelName = $"ContactUploadingLog-{request.SelectedDateRange.dateStart.Value.ToString("yyyyMMdd")}-{request.SelectedDateRange.dateEnd.Value.ToString("yyyyMMdd")}.xlsx";
...
//                {
//                    ExcelWorksheet worksheet = package.Workbook.Worksheets.Add("تمت الاضافة");
...
//                    worksheet.Column(j).Width = 20; worksheet.Cells[1, j].Value = "حالة الرفع"; j++;
...
//                         worksheet.Cells[rowNumber, columnNumber].Value = "تمت الاضافة"; columnNumber++;
