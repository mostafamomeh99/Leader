...
{
    public class EntityFieldOptionCondition : AuditableEntity<Guid>
    {
        public Guid EntityFieldOptionConditionGroupId { get; set; }
        public virtual EntityFieldOptionConditionGroup? EntityFieldOptionConditionGroup { get; set; }
